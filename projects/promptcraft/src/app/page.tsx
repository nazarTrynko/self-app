        ...
        <div className="section-container">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a
                href="#features"
                className="text-sm text-obsidian-400 hover:text-white transition-colors"
              >
                Features
              </a>
              <a
        ...
        <div className="section-container relative">
          ...
          >
            ...
            >
              ...
              each improvement makes them more powerful. Learn the craft while
              you create.
            </motion.p>
          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-obsidian-400 max-w-xl mx-auto">
                Paste any prompt and watch The Alchemist reveal the hidden
                improvements.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div
                  className="alchemist-input cursor-pointer"
                  onClick={triggerDemo}
                >
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <p className="text-obsidian-200">
                    You are a productivity expert who has helped thousands of
                    professionals optimize their workflows. Write a 1,500-word
                    blog post for ambitious professionals in their 30s who
                    struggle with focus in the remote work era.
                    <br />
                    <br />
                    <span className="text-gold-400">Structure:</span> Hook with
                    a relatable scenario → 3 actionable frameworks → Real
                    examples → Clear takeaways
                    <br />
                    <br />
                    <span className="text-gold-400">Tone:</span> Conversational
                    but authoritative, no fluff, respect the reader&apos;s time
                    <br />
                    <br />
                    <span className="text-gold-400">Avoid:</span> Generic advice
                    like &quot;make a to-do list&quot; — focus on
                    counterintuitive insights backed by research
                  </p>
                </motion.div>
              </div>
            </div>
                ...
                {[
                  {
                    ...
                    desc: "AI performs better with expertise context",
                  },
                  {
                    label: "Specific Audience",
                    desc: "Targeted content outperforms generic",
                  },
                  {
                    label: "Clear Structure",
                    desc: "Reduces ambiguity, improves output quality",
                  },
                  {
                    label: "Constraints",
                    desc: "Boundaries focus the AI, eliminate fluff",
                  },
                ].map((item, i) => (
                  <div key={i} className="p-3 rounded-lg bg-obsidian-900/50">
                    <span className="text-gold-400 font-medium block mb-1">
                      {item.label}
                    </span>
        ...
        <div className="section-container">
          ...
          >
            <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
              More Than a Tool.{" "}
              <span className="gradient-text">A Teacher.</span>
            </h2>
            <p className="text-obsidian-400 max-w-2xl mx-auto text-lg">
              Every transformation is a lesson. Learn why prompts work, not just
              what to write.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Paste any prompt and get immediate insights on structure, specificity, and context.",
                color: "text-gold-400",
              },
              {
                icon: Brain,
                title: "Learn the Why",
                description:
                  "Every improvement comes with an explanation. Understand the craft, not just the result.",
              ...
              },
              {
                ...
                description:
                  "Discover the 7 prompt patterns that work across any AI model or use case.",
              ...
              },
              {
                ...
                title: "Prompt DNA",
                description:
                  "Coming soon: Deep-dive courses on the science of prompt engineering.",
                color: "text-gold-400",
              },
              {
                icon: Users,
                title: "Community",
                description:
                  "Coming soon: Share your best prompts, learn from masters, grow together.",
                color: "text-arcane-400",
              },
              {
                icon: Sparkles,
                title: "Marketplace",
                description:
                  "Coming soon: Sell your prompt expertise. Buy proven prompt systems.",
                color: "text-ember-400",
              },
            ].map((feature, i) => (
              <motion.div
            ...
            {[
              {
                ...
                description:
                  "Drop in any prompt you use with ChatGPT, Claude, or any AI assistant.",
              },
              {
                step: "02",
                title: "Watch It Transform",
                description:
                  "The Alchemist analyzes structure, adds context, and optimizes for better results.",
              },
              {
                step: "03",
                title: "Learn & Apply",
                description:
                  "Understand why each change matters. Apply the patterns to every future prompt.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-center gap-3 text-obsidian-300"
                  >
            ...
            >
              ...
              <div className="text-4xl font-bold mb-6">
                $9
                <span className="text-lg font-normal text-obsidian-400">
                  /month
                </span>
              </div>
              <ul className="space-y-3 mb-8">
        ...
        <div className="section-container relative">
          ...
          >
            ...
            <p className="text-obsidian-400 mb-8 text-lg">
              Join the waitlist for early access. We&apos;re launching soon with
              limited spots.
            </p>
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="text-obsidian-400">
                  We&apos;ll notify you as soon as The Alchemist is ready for
                  you.
                </p>
              </motion.div>
            ) : (
